...
const P04 = 'La billetera esta bloqueada'
const P05 = 'La plataforma ya se encuentra bloqueada'
...
const B07 = 'No se puede bloquear al propietario'
const B08 = 'La billetera ya se encuentra bloqueada'
...
const O10 = 'La orden se encuentra bloqueada y no se puede ejecutar'
